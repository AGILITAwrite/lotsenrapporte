sap.ui.define([
	...
	return BaseController.extend("ch.portof.controller.Rapport", {
		...
		onSave: function() {
			...
			//var oSignaturModel = this.getView().getModel("Signature");
			//var oRapportModel = this.getView().getBindingContext();
			...
			if (oSignature) {
				...
				if (oSignatureBase30) {
					...
					if (isSignatureProvided) {
						...
						//oRapportModel.setProperty("/Signatur", oSignature.jSignature("getData", "image") );
			...
			//	oRapportModel.submitChanges({success: this.__sucess, error: this.__error});
